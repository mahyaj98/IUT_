...
public class ChatClient2 {
    public ChatClient2(String username, String password, String mode,
    ...
    public static void main(String[] argv){
        ...
        String username = "Dina";//argv[1];
        String password = "aAaAaA123*";//argv[2];
        ...
        try{
            new ChatClient2(username, password, mode, hostname, ChatServer.portNum, clientPrivateKey, clientPublicKey);
        }catch(IOException x){
            x.printStackTrace();
        }
    }
